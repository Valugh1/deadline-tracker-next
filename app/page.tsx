...
import { Deadline } from '@/components/DeadlineCard'; // Assicurati di importare il tipo
      ...
      <div className="w-full px-6 py-10 md:px-12 md:py-16 lg:px-20">
        ...
        <header className="grid grid-cols-3 items-end mb-12 max-w-[1800px] mx-auto px-2">
          ...
          <div className="text-center col-span-3 md:col-span-1">
            <p className="text-ios-gray font-semibold uppercase tracking-widest text-[10px] md:text-xs mb-1">I miei promemoria</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">Scadenze</h1>
          </div>
          <div className="flex justify-end items-center absolute right-6 top-10 md:static">
            ...
            >
              <Image src="/icons/add-square-svgrepo-com.svg" alt="Aggiungi" width={32} height={32} className="w-6 h-6 md:w-8 md:h-8 brightness-0 invert"/>
            </button>
          </div>
        </header>
