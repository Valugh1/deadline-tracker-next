  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
      ...
      <div className="relative bg-white w-full max-w-lg rounded-[32px] overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div
          className={`p-8 ${deadline.type === "daily" ? "bg-ios-blue" : "bg-gray-900"} text-white`}
        >
        ...
        <div className="p-8 space-y-8">
          {/* Info Principali */}
          {deadline.type === "daily" ? (
            /* --- VISTA GIORNALIERA (Unico riquadro) --- */
            <div className="bg-gray-50 p-4 rounded-2xl w-full border border-gray-100">
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`w-3 h-3 rounded-full ${deadline.isDone ? "bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.4)]" : "bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.4)]"}`}
                />
                <p
                  className={`text-xl font-black ${deadline.isDone ? "text-green-600" : "text-amber-600"}`}
                >
            ...
            /* --- VISTA LONG TERM (Griglia a due colonne) --- */
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-gray-50 p-4 rounded-2xl">
                ...
                <p
                  className={`text-lg font-bold ${daysLeft < 0 ? "text-red-500" : "text-green-500"}`}
                >
            ...
            <div className="bg-gray-50 rounded-2xl p-5 min-h-[100px] border border-gray-100">
              {deadline.notes ? (
                ...
                <p className="text-gray-400 italic">
                  Nessuna nota inserita per questa scadenza.
                </p>
              )}
            </div>
          </div>
